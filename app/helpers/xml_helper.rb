...
module XmlHelper
  ...
  private_constant :QUARTERS_HASH
  ...
  def self.download_latest_xml(filename)
    ...
    client = DropboxClient.new('Pu-hL21vvKwAAAAAAACQwGq902w2bxE3yw8TwMphQDdZK4r9_KuZS4QKwaanBI1c')
    client.put_file("XMLs/#{filename}.xml", xml_file)

    puts "Parsing with Nokogiri..."
    xml_doc = Nokogiri::XML(xml_file)
    courses = xml_doc.css('course')
